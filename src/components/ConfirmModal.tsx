      ...
      >
        ...
        <div className="p-8 flex flex-col items-center text-center gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm font-bold text-black/60 leading-relaxed">
              {message}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 border-t-2 border-black divide-x-2 divide-black">
          <button
            ...
            disabled={isLoading}
            className="
                p-4 text-sm font-black uppercase tracking-wider text-black
          ...
          <button
            ...
            className={`
                ...
                ${
                  variant === "danger"
                    ? "bg-black text-white hover:bg-gray-800" // Danger = Solid Black
                    : "bg-black text-white hover:bg-gray-800" // Neutral = Solid Black
                }
            `}
          >
