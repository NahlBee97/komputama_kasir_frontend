  ...
  return (
    <aside className="hidden md:flex flex-col w-72 h-full bg-white p-5">
      ...
      <div className="flex items-center gap-3 px-2 mb-10 mt-2">
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#007ACC] text-white shadow-[3px_3px_0px_0px_rgba(0,0,0,0.3)]">
          <img src="/diarylogo.jpeg" alt="logo" className="rounded-lg" />
        </div>
        <h1 className="text-2xl font-black uppercase tracking-tighter text-[#007ACC] leading-none">
          Komputama Kasir
        </h1>
      </div>
      ...
      <nav className="flex flex-1 flex-col justify-between gap-2">
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${
                    active
                      ? "bg-[#007ACC] text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] translate-x-0.5 translate-y-0.5"
                      : "text-[#007ACC]/70 hover:bg-gray-100 hover:text-[#007ACC] hover:translate-x-0.5"
                  }
                `}
              >
                ...
                <span
                  className={
                    active ? "text-white" : "text-[#007ACC] group-hover:text-[#007ACC]"
                  }
                >
                  {navLink.icon}
                </span>
        ...
        {/* Logout Button */}
        <div className="border-t-2 border-[#007ACC]/10 pt-4">
          <button
            onClick={() => handleLogout()}
            className="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-[#007ACC]/70 hover:bg-red-50 hover:text-red-600 transition-colors duration-200 group"
          >
